...
\newcommand{\PrintAllStatSystsPlots}{
    \foreach\VarName/\VarLabel in \VarList {
        \begin{figure}[H]
            ...
            \includegraphics[width=3in]{./../Figs/CAFAna/Uncertainties/Statistical/CovBkg\VarName.png} \\
            \caption{Statistical covariance matrix for reconstructed and background~\VarLabel.}
