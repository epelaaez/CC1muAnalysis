...
Since GiBUU is the outlier, we checked the specific interaction mode for the RES events. WE got that 10 has 39.3\%, 11 has 34.7\%, 12 has 0.0136\%, 13 has 26 \%, and 27, 22, and 23 all have zero percent of the RES events.
...
\begin{figure}
    ...
    \caption{Event interaction breakdown pre final state interactions}
