...
\begin{figure}
    \centering
    \subfloat{\includegraphics[width=3in]{Figs/Overlay/Overlay_TrueMuonMomentumPlot.png}}
    \subfloat{\includegraphics[width=3in]{Figs/Overlay/Overlay_TrueMuonCosThetaPlot.png}} \\
    \subfloat{\includegraphics[width=3in]{Figs/Overlay/Overlay_TrueLeadingProtonMomentumPlot.png}}
    \subfloat{\includegraphics[width=3in]{Figs/Overlay/Overlay_TrueLeadingProtonCosThetaPlot.png}} \\
    \subfloat{\includegraphics[width=3in]{Figs/Overlay/Overlay_TrueRecoilProtonMomentumPlot.png}}
    \subfloat{\includegraphics[width=3in]{Figs/Overlay/Overlay_TrueRecoilProtonCosThetaPlot.png}} \\
