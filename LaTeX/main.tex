...
is shown in Figures~\labelcref{fig:unfolded-fake-data-vector,fig:unfolded-fake-data-opening-angles-transverse,fig:unfolded-fake-data-double-differential,fig:unfolded-fake-data-sliced-double-differential}.
...
\begin{figure}
    ...
    \caption{Unfolded fake data showing agreement with smeared fake signal data for single differential vector directions and magnitudes.}
    \label{fig:unfolded-fake-data-vector}
\end{figure}
...
\begin{figure}
    ...
    \caption{Unfolded fake data showing agreement with smeared fake signal data for single differential vector opening angles and transverse momentum.}
    \label{fig:unfolded-fake-data-opening-angles-transverse}
\end{figure}
...
\begin{figure}
    ...
    \caption{Unfolded fake data showing agreement with smeared fake signal data for serial double differential variables.}
    \label{fig:unfolded-fake-data-double-differential}
\end{figure}
...
\begin{figure}
    ...
    \caption{Unfolded fake data showing agreement with smeared fake signal data for sliced double differential variables.}
    \label{fig:unfolded-fake-data-sliced-double-differential}
\end{figure}

\subsection{QE 2x weight}\label{sec:qe-2x-weight}
