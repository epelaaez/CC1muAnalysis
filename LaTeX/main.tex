...
\subsection{Wiener-SVD additional smearing matrices}\label{sec:wiener-svd-smearing-matrices}

The additional smearing matrices obtained from the Wiener-SVD unfolding are shown in this section.
