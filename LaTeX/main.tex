...
\newcommand{\PrintAllStatSystsPlots}{
    \foreach\VarName/\VarLabel in \VarList {
        \begin{figure}[H]
            \centering
            \includegraphics[width=3in]{./../Figs/CAFAna/Uncertainties/Statistical/\VarName.png}
                \includegraphics[width=3in]{./../Figs/CAFAna/Uncertainties/Statistical/CovReco\VarName.png} \\
                \includegraphics[width=3in]{./../Figs/CAFAna/Uncertainties/Statistical/FracCovReco\VarName.png}
                \includegraphics[width=3in]{./../Figs/CAFAna/Uncertainties/Statistical/CorrReco\VarName.png}
...
\begin{table}
    \begin{center}
        ...
        All reco events      & $7.09465\cdot10^6$ & 100\%   & -       & -      \\
        Cosmic cut           & $5.74938\cdot10^6$ & 81.0381\% & 89.6205\% & 4.24241\% \\
        Vertex in FV cut     & $3.23953\cdot10^6$ & 45.6616\% & 88.2885\% & 7.41734\% \\
        One muon cut         & $2.20417\cdot10^6$ & 31.068\% & 70.5202\% & 8.70753\% \\
        Two protons cut      & 146443 & 2.06413\%  & 17.517\% & 32.5549\% \\
        No charged pions cut & 67441.8 & 0.9506\%  & 12.6665\% & 51.1156\% \\
        No neutral pions cut & 54514.3 & 0.768385\%  & 11.3094\% & 56.4617\% \\ \hline
        \end{tabular}
    \end{center}
...
In this appendix, the covariance matrices for the statistical systematics are plotted.
