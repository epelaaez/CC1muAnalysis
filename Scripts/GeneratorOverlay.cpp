...
void GeneratorOverlay() {
	...
	// TString OutFilePath = "/exp/sbnd/app/users/epelaez/BuildEventGenerators/FlatTreeAnalyzer/OutputFiles/";
	// TString OutFilePath = "/exp/sbnd/app/users/epelaez/BuildEventGenerators/FlatTreeAnalyzer/OutputFilesHighStats/";
	...
	for (int iPlot = 0; iPlot < NPlots; iPlot++) {
		...
		PlotCanvas->cd();
		leg->Draw();
		PlotCanvas->SaveAs("./figs/1M_"+PlotNames[iPlot]+".png");
		// PlotCanvas->SaveAs("./OutputFilesHighStats/figs/overlay.png");
